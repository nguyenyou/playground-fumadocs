...
<Playground preset="vanilla" height="400">
...
<Playground height="600" config={{ supportTailwind: false, supportReact: false, includeResetCSS: false, includeRootDiv: false, additionalHead: ['<meta name="author" content="Custom Playground">', '<meta name="description" content="Custom playground example">', '<link rel="preconnect" href="https://fonts.googleapis.com">', '<link href="https://fonts.googleapis.com/css2?family=Inter:wght@400;600;700&display=swap" rel="stylesheet">'] }}>
